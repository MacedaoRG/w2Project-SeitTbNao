...
public:
	...
	int OnPacketAction(PacketHeader* pStd);
	int OnPacketSoundEffect(MSG_STANDARDPARM* pStd);
	int OnPacketCreateMob(PacketHeader* pStd);
	...
	int OnPacketAutoTrade(PacketHeader* pStd);
	int OnPacketSwapItem(PacketHeader* pStd);
	int OnPacketShopList(PacketHeader* pStd);
	int OnPacketRMBShopList(MSG_RMBShopList* pMsg);
	int OnPacketBuy(PacketHeader* pStd);
	int OnPacketSell(PacketHeader* pStd);
	...
	int OnPacketEnvEffect(PacketHeader* pStd);
	int OnPacketRemainNPCCount(MSG_STANDARDPARM* pStd);
	int OnPacketRESULTGAMBLE(PacketHeader* pStd);
