...
public:
    ...
    int OnPacketRemoveMob(PacketHeader* pStd);
    int OnPacketSendItem(PacketHeader* pStd);
    int OnPacketUpdateEquip(PacketHeader* pStd);
    int OnPacketUpdateAffect(PacketHeader* pStd);
    int OnPacketUpdateScore(PacketHeader* pStd);
    int OnPacketSetHpMp(MSG_SetHpMp* pStd);
    int OnPacketSetHpDam(PacketHeader* pStd);
    int OnPacketMessageChat(PacketHeader* pStd);
    int OnPacketMessageChat_Index(PacketHeader* pStd);
    int OnPacketMessageChat_Param(PacketHeader* pStd);
    int OnPacketMessageWhisper(MSG_MessageWhisper* pMsg);
    int OnPacketUpdateEtc(PacketHeader* pStd);
    int OnPacketUpdateCoin(MSG_STANDARDPARM* pStd);
    int OnPacketUpdateRMB(MSG_STANDARDPARM* pStd);
    int OnPacketTrade(MSG_Trade* pStd);
    int OnPacketQuitTrade(PacketHeader* pStd);
    int OnPacketCarry(MSG_Carry* pStd);
    int OnPacketCNFCheck(PacketHeader* pStd);
    int OnPacketSetClan(MSG_STANDARDPARM* pStd);
    int OnPacketReqRanking(MSG_STANDARDPARM2* pStd);
    int OnPacketVisualEffect(PacketHeader* pStd);
    int IsMerchant();
    void Init();
